...
// linux, win32
rs485_inst_t rs485_new(void *, rs485_fn_t *);
//rs485_t rs485_new(const char *, fn_t, fn_t, void *, const char *, u32_t);
void    rs485_del(rs485_inst_t);
void    rs485_ena(rs485_inst_t, bool, bool);
void    rs485_poll(rs485_inst_t);
bool    rs485_get(rs485_inst_t, u8_t *);
bool    rs485_put(rs485_inst_t, u8_t);
